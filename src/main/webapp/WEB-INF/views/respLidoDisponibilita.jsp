        ...
        <p>
          ...
          <c:choose>
            ...
            <c:when test="${size > 0}">
              ...
              Sono occupati i seguenti ombrelloni:
            <c:forEach var="ombrellone" items="${ombrelloni}">
              <i class="fa fa-square"></i>
              POSTO-${ombrellone.num_righe}${ombrellone.num_colonne}<br>
            </c:forEach>

            </c:when>
            <c:otherwise>
              Nessun ombrellone attualmente occupato nel periodo da te scelto :(
            </c:otherwise>
          </c:choose>
        </p>
      </c:if>
